/**********************************************************
 * INSTRUCTIONS FOR ADDING WHOLESALE BACKEND
 *
 * 1. Open Google Apps Script editor for your Production Sheet
 * 2. Scroll to the END of Code.gs (after line 3201)
 * 3. Copy EVERYTHING BELOW this comment block
 * 4. Paste at the end of Code.gs
 * 5. Add the API routes (see section at bottom)
 * 6. Save and deploy
 **********************************************************/
...
/**********************************************************
 * API ROUTING - ADD THESE TO EXISTING doGet() AND doPost()
 **********************************************************/

/*
ADD TO doGet() function (around line 70):
...
ADD TO doPost() function (around line 130):
