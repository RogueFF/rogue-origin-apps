...
var SHEET_ID = 'REDACTED-ORDERS-SHEET-ID';
  ...
  try {
    ...
    if (manualCompletedKg != null && manualCompletedKg >= 0) {
      ...
      if (remainingKg > 0) {
        ...
        try {
          var PRODUCTION_API_URL = 'https://script.google.com/macros/s/REDACTED-PRODUCTION-API-ID/exec';
    ...
    var PRODUCTION_SHEET_ID = 'REDACTED-PRODUCTION-SHEET-ID';
