...
var SHEET_ID = 'REDACTED-PRODUCTION-SHEET-ID';
var AI_MODEL = 'claude-sonnet-4-20250514';
var WHOLESALE_ORDERS_API_URL = 'https://script.google.com/macros/s/REDACTED-WHOLESALE-API-ID/exec';
var WHOLESALE_ORDERS_SHEET_ID = 'REDACTED-ORDERS-SHEET-ID';
...
function buildSystemPrompt(context, corrections, memoryResults) {
  ...
  prompt += '\nTo execute a task, include this JSON block in your response:\n' +
    ...
    'User: "New shipment for [CUSTOMER REDACTED]: 20kg Lifter Tops and 20kg Sour Lifter Tops"\n' +
    'Assistant: "Creating shipment with multiple items.\n```task\n{"task": "create_shipment", "params": {"customerName": "[CUSTOMER REDACTED]", "items": [{"strain": "Lifter", "type": "Tops", "quantity": 20}, {"strain": "Sour Lifter", "type": "Tops", "quantity": 20}]}}\n```"\n\n' +
    ...
    'User: "What shipments exist for [CUSTOMER REDACTED]?"\n' +
    'Assistant: "Let me check [CUSTOMER REDACTED]\'s shipments.\n```task\n{"task": "get_shipments", "params": {"customerName": "[CUSTOMER REDACTED]"}}\n```"\n\n' +
...
function testGetShipments() {
  var result = executeGetShipments_({
    customerName: "[CUSTOMER REDACTED]"
  });
