...
const S = {
  es: {
    ...
    notOpened: 'Todavía sin abrir. Anota los pesos cuando se abra:',
    openedAt: 'Abierta {t} UTC',
    ...
    findHelp: 'Escanea la etiqueta o escribe el número — <strong>26-SL-12</strong> o nada más <strong>SL-12</strong>.',
    findPlaceholder: '26-SL-12',
  ...
  en: {
    ...
    notOpened: 'Not yet opened. Record weights when this sack is opened:',
    openedAt: 'Opened {t} UTC',
    weights: '{tops} lb tops · {smalls} lb smalls',
    ...
    findHelp: 'Scan the tag or type the number — <strong>26-SL-12</strong> or just <strong>SL-12</strong>.',
    findPlaceholder: '26-SL-12',
