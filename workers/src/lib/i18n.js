...
const S = {
  es: {
    ...
    justMoved: '↩️ La cuadrilla acaba de entrar a {newZone}. Se preseleccionó <strong>{prevZone}</strong> porque una traila que llega ahorita casi siempre se cargó allí — compáralo con la carga y cámbialo si no.',
    ...
    atStation: 'Recepción {n} · Cuadrilla {crew}',
    testBand: '⚠ Modo de prueba',
    dayEnd: 'Fin del día',
    dayEndClosed: 'Se cerró {lot}',
    dayEndAfter: 'Después de {h} horas en la zona',
    dayEndTomorrow: 'Mañana vuelve a escanear el letrero de la zona donde sigan cortando.',
    dayEndNothing: 'No había ninguna zona abierta',
    dayEndNothingSub: 'Puede que ya la hayas cerrado, o que el letrero se haya escaneado con otro teléfono. No pasa nada.',
    dayEndNoCrew: 'Este teléfono no tiene cuadrilla — cerró la zona sin cuadrilla.',
    dayEndOtherOpen: '⚠️ <strong>{zone}</strong> sigue abierta ({crew}). Avísales para que también cierren.',
    dayEndUntagged: 'sin cuadrilla',
    cultivarSwitched: 'Se anotó a **{prev}**, no a {now} — acaban de cambiar de variedad en esta zona. Si la traila se cargó después del cambio, avisa.',
    otherCrewZone: 'Mostrando la zona de la Cuadrilla {crew} — esta recepción aún no tiene zona abierta.',
    untaggedZone: 'Mostrando una zona abierta desde un teléfono sin cuadrilla — esta recepción aún no tiene zona abierta.',
    atStationNoCrew: 'Recepción {n}',
    crossedCrew: 'Atribuido a la zona de la Cuadrilla {crew}, no a la de esta recepción. Revisa la zona si está mal.',
    printCodes: 'Códigos para imprimir',
    crewTag: 'Cuadrilla {crew}',
    crewTagSet: 'Este teléfono es la Cuadrilla {crew}',
    crewTagSetSub: 'Se recordará en este teléfono toda la temporada. Escanea el letrero de tu zona como siempre.',
    crewTagNone: 'Sin cuadrilla',
    crewTagUnknown: 'Este teléfono no tiene cuadrilla',
    crewTagUnknownSub: 'Escanea la tarjeta de Cuadrilla A o Cuadrilla B una vez. Sin ella tu zona puede cerrarse cuando la otra cuadrilla escanee.',
    crewTagBad: 'Esa tarjeta de cuadrilla no se reconoce.',
    ...
    bayRange: 'La bahía debe estar entre {min} y {max}.',
    noBaySet: 'Sin bahía',
    // — bahía al recibir la carga (¿dónde se está colgando?) —
    bayHung: '¿En cuál bahía se cuelga?',
    bayHungHint: 'Déjalo en blanco si no sabes',
    bayHungLast: 'La última carga fue a la {n}',
    bayStale: 'La {n} fue de otro día — confirma que sigue siendo esa',
    bayUnknown: 'No sé todavía',
    hungInBay: 'colgada en la bahía {n}',
    // — tablero: qué se está secando en cuál bahía —
    racksTitle: 'En las bahías ahora',
    racksSub: 'Qué está colgado en cuál bahía, y desde hace cuántos días.',
    racksEmpty: 'vacía',
    racksHanging: 'colgado',
    racksComingDown: 'bajando',
    racksDays: '{d} d',
    racksBins: '{n} cajas',
    racksNothing: 'Todavía no se ha registrado ninguna bahía al recibir cargas.',
    tlDriedIn: 'secada en la bahía {n}',
    wTops: 'Tops', wSmalls: 'Smalls', wBiomass: 'Biomasa', wTrim: 'Trim', wWaste: 'Merma',
    wWasteNote: 'La merma no se pesa — es lo que queda de los {fill} lb después de las otras cuatro partes.',
  ...
  en: {
    ...
    justMoved: '↩️ The crew just moved into {newZone}. <strong>{prevZone}</strong> is pre-selected because a trailer arriving now was most likely loaded there — check it against the load and change it if not.',
    ...
    atStation: 'Barn intake {n} · Crew {crew}',
    testBand: "⚠ Test mode",
    dayEnd: 'End of day',
    dayEndClosed: 'Closed {lot}',
    dayEndAfter: 'After {h} hours in the zone',
    dayEndTomorrow: 'Tomorrow, scan the zone sign again wherever they pick up.',
    dayEndNothing: 'Nothing was open',
    dayEndNothingSub: 'You may have closed it already, or the sign was scanned on another phone. Either way this is fine.',
    dayEndNoCrew: 'This phone has no crew tag — it closed the untagged zone.',
    dayEndOtherOpen: '⚠️ <strong>{zone}</strong> is still open ({crew}). Tell them to close it too.',
    dayEndUntagged: 'no crew',
    cultivarSwitched: "Logged to **{prev}**, not {now} — the cultivar in this zone just changed. If this trailer was loaded after the change, say so.",
    otherCrewZone: "Showing Crew {crew}'s zone — this intake's crew has nothing open yet.",
    untaggedZone: "Showing a zone opened from a phone with no crew — this intake's crew has nothing open yet.",
    atStationNoCrew: 'Barn intake {n}',
    crossedCrew: "Attributed to Crew {crew}'s zone, not this intake's. Check the zone if that is wrong.",
    printCodes: 'Codes to print',
    crewTag: 'Crew {crew}',
    crewTagSet: 'This phone is Crew {crew}',
    crewTagSetSub: 'Remembered on this phone for the season. Scan your zone sign as usual.',
    crewTagNone: 'No crew',
    crewTagUnknown: 'This phone has no crew',
    crewTagUnknownSub: 'Scan the Crew A or Crew B card once. Without it your zone can be closed when the other crew scans.',
    crewTagBad: 'That crew card is not recognised.',
    ...
    bayRange: 'Bay must be between {min} and {max}.',
    noBaySet: 'No bay set',
    bayHung: 'Which bay is this hung in?',
    bayHungHint: 'Leave blank if you do not know',
    bayHungLast: 'Last load went to {n}',
    bayStale: '{n} was a different day — check it is still that one',
    bayUnknown: 'Not sure yet',
    hungInBay: 'hung in bay {n}',
    racksTitle: 'On the racks right now',
    racksSub: 'What is hanging in which bay, and how long it has been there.',
    racksEmpty: 'empty',
    racksHanging: 'hanging',
    racksComingDown: 'coming down',
    racksDays: '{d} d',
    racksBins: '{n} bins',
    racksNothing: 'No bay has been recorded at intake yet.',
    tlDriedIn: 'dried in bay {n}',
    wTops: 'Tops', wSmalls: 'Smalls', wBiomass: 'Biomass', wTrim: 'Trim', wWaste: 'Waste',
    wWasteNote: 'Waste is not weighed — it is whatever is left of the {fill} lb after the other four parts.',
