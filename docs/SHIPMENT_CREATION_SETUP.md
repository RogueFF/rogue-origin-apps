...
**Ask the AI:**
```
Create a shipment for [CUSTOMER REDACTED], 500kg Lifter Tops
```
...
**Ask the AI:**
```
Create a shipment for [CUSTOMER REDACTED]: 20kg Lifter Tops and 20kg Sour Lifter Tops
```
...
**Ask the AI:**
```
What shipments exist for [CUSTOMER REDACTED]?
```

**AI Response:**
```
Found 2 shipment(s) for [CUSTOMER REDACTED]
...
- Example: MO-2026-001 for [CUSTOMER REDACTED]
...
```
User: "Create a shipment for [CUSTOMER REDACTED], 500kg Lifter Tops"
AI: [Creates shipment with auto-generated ID and invoice number]
```

### Create Multi-Item Shipment
```
User: "Create a shipment for [CUSTOMER REDACTED]: 20kg Lifter Tops and 20kg Sour Lifter Tops"
