...
export const T = {
  ...
  ulineGo: ['Uline Quick Order ↗', 'Uline Quick Order ↗'], ulineHow: ['List copied · on Uline click “Paste Items Page”, paste, then Add to Cart', 'Lista copiada · en Uline toca «Paste Items Page», pega y luego Add to Cart'], ulinePasteHead: ['Paste this on Uline → Quick Order → Paste Items Page', 'Pega esto en Uline → Quick Order → Paste Items Page'], searchByName: ['search on Uline by name', 'buscar en Uline por nombre'],
