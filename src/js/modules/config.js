...
export const kpiDefinitions = [
  ...
  { id: 'costPerLb', label: 'Cost/Lb (Blend)', icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="2"/><path d="M12 6v12M15 9h-4.5a2.5 2.5 0 0 0 0 5h3a2.5 2.5 0 0 1 0 5H9" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg>', color: 'indoor', default: false, visible: false, format: 'dollar' },
  { id: 'topsCostPerLb', label: 'Tops Cost/Lb', icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="2"/><path d="M12 6v12M15 9h-4.5a2.5 2.5 0 0 0 0 5h3a2.5 2.5 0 0 1 0 5H9" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><ellipse cx="12" cy="6" rx="3" ry="1.5" fill="currentColor" opacity="0.3"/></svg>', color: 'gold', default: true, visible: true, format: 'dollar' },
  { id: 'smallsCostPerLb', label: 'Smalls Cost/Lb', icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="2"/><path d="M12 6v12M15 9h-4.5a2.5 2.5 0 0 0 0 5h3a2.5 2.5 0 0 1 0 5H9" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><ellipse cx="12" cy="18" rx="2" ry="1" fill="currentColor" opacity="0.3"/></svg>', color: 'sungrown', default: true, visible: true, format: 'dollar' },
