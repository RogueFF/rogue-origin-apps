...
var API_URL = 'https://script.google.com/macros/s/REDACTED-PRODUCTION-API-ID/exec';
...
function renderHero() {
  ...
  // Uses actual performance to project realistically (matches scoreboard calculation)
  ...
  var predictedTops = tops + (trimmers * todayRate * remainingHours);
