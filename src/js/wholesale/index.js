...
registerLabels({
  en: {
    ...
    done_lbs: 'pounds done', from_stock: 'from stock — not trimmed',
    ...
    raw_needed: 'Raw needed', on_hand: 'on hand', estimate: 'estimate', sacks: 'sacks',
  ...
  es: {
    ...
    done_lbs: 'libras hechas', from_stock: 'de inventario — no podado',
    ...
    raw_needed: 'Crudo necesario', on_hand: 'disponibles', estimate: 'estimado', sacks: 'sacos',
