...
export const agents: Agent[] = [
  ...
  { id: 'meridian', name: 'Meridian', color: '#3b82f6', status: 'running', task: '[CUSTOMER REDACTED] status', lastActivity: '3m ago' },
...
export const activities: Activity[] = [
  {
    ...
    body: 'DECODED TRANSMISSION // 47.2 lbs processed across 3 strains. Crew of 6 maintaining 12.1 lbs/hr. Cherry Pie lot CP-2026-017 completing final dry cycle. [CUSTOMER REDACTED] shipment ETA Wednesday.',
    timestamp: '08:00',
  ...
  },
  {
    ...
    type: 'briefing',
    title: 'Market Intel',
    body: 'European market signals stable. [CUSTOMER REDACTED] confirmed Wednesday delivery slot.',
    timestamp: '10:20',
    accentColor: 'var(--accent-cyan)',
  },
  {
